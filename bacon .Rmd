...
# we now want to make the ratings into numbers so we are better able to manipulate these subsets
...
#changes rating from char to num and makes it better able to access
as.numeric(df$Rating)
...
# This function is able to take in any actor in which you give the function and will return the Hank number that it has, as well as it will return an error if it is spelled wrong
